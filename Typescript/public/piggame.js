...
// Ins
let playerOne = new Player("playerOne", 0, 0, document.querySelector("#current--0"), document.querySelector("#score--0"), document.querySelector(".player--0"));
let playerTwo = new Player("playerTwo", 0, 0, document.querySelector("#current--1"), document.querySelector("#score--1"), document.querySelector(".player--1"));
...
btnNewGame.addEventListener("click", () => {
    restartGame(playerOne.section.classList.contains("player--winner")
        ? playerOne
        : playerTwo);
});
